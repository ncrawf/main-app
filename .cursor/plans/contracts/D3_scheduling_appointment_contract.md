...
| `staff_service_assignment` (DL-15 amendment 31) | **3-component block**: `prep_time` + `booking_time` + `finish_time` (per staff per service); patient sees booking_time only; resource lock spans all 3 |
