...
**★ 2026-08-10 — RECONCILIATION DONE; AMENDMENT CYCLE APPLIED.** `v4_FAI_PRE0_reconciliation_ledger_2026-08-09.md` is at **R1**: **81 rows classified · 7 open · 0 out-of-scope**. The single bounded amendment cycle has been **applied** to charter (**R7**), execution plan (**R6**), protocol and this handoff. **11 of 14 fully closed** (ledger §8) — `C-01` partially closed for the G0 transaction only · `C-10` specified but not executed · `C-11`/`C-12` were falsely claimed at R1 and close at R2. **The earlier "13 of 14" claim is withdrawn as not byte-true.**
