...
## §0 Status Posture — PHASE G.2.a EXECUTED (`D0THES-DEC-021`); DL-18 PROMOTED to LOCKED + cluster C4 (per-event ownership orthogonality / T0-13) landed at both homes (DL-16 inv 2 `ownership_dimensions` 7-axis field + DL-18 inv 25); REV-113 closed + REV-111 ownership-half landed; **STOPPED for Nick/Knox checkpoint before G.2.b** (per D7 batched-checkpoint discipline). **CHECKPOINT FLAGS**: (1) promotion mechanic = status-flip + register-lock + amendment, full-inline relocation deferred to substrate-slice (worked template — confirm or switch to full-inline before G.2.b repeats ×5); (2) G.2 is batched G.2.a-f, NOT one-shot. [Prior: G.1 executed (Tier 0 → 13, Nick-approved); F.3 ratified §20; F.2 closed §19.]
