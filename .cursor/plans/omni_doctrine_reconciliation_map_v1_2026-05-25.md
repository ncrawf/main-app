...
## §0 Status Posture — PHASE G.1 EXECUTED (thesis spine adjudication; `D0THES-DEC-020`); 6 Tier 0 guardrails promoted (T0-08/09/13/14/15/16) + T0-11/12 demoted to architecture canon; **STOPPED for Nick/Knox checkpoint before G.2** (per D7 launch discipline). [Prior: F.3 ratified §20; F.2 closed + F.2.3 complete §19.] CHECKPOINT FLAG: Tier 0 now 13 entries; T0-14 fold-into-T0-09 fallback documented if judged too long. Detailed substrate for promoted guardrails lands G.2-G.4 (NOT in G.1).
