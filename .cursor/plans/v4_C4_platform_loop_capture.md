...
> **★ Naming note (2026-07-12, Knox):** the pre-release plane is **Platform Change Engineering (PCE)** — NOT "Build-OS." The **OMNI Build-OS** (`09`/`10`/`11`) is a *different, orthogonal* system (the meta-operating-system through which agents/engineers build OMNI safely). PCE = the product engineering plane that turns an approved change into a validated release candidate, *governed by* the Build-OS meta-system. Working term; finalizes at the spine.
