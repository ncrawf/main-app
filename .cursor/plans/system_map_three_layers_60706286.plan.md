...
- **Re-consent on material change:** when terms or **clinical** modules materially change, a re-consent module fires before submission (versioned consent record per `1K.11`).
