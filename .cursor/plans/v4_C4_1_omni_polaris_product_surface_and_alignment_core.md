...
## §4a-0 — Care-first North Star (the guardrail; the hard middle SERVES this, it is not this)
**The mission is NOT "the hard middle." The mission is: OMNI exists to bring patients into organized, accountable, AI-assisted provider care.** Patient care is the North Star (the *why*); everything else earns its place in the thesis **only by its causal line to the care the patient actually receives** — a means-ends chain, NOT a priority ranking:
