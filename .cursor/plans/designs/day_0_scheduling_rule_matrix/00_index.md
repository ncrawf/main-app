...
| 5 | Service occurrence creation/linking rules — encounter_view projection where clinical | [05_domain_service_occurrence.md](05_domain_service_occurrence.md) | Round 5 | **CLOSED (design/doctrine closure)** | 34 Day 0 (+ wide-breadth OMNI scenario corpus) | Closure gate satisfied via K(C) path A + bridge lock + formal DL amendment entries; D6/D7 carry-forward obligations explicit | §2.21 universal kickoff + §2.23 CNS parent contract + §2.24 Domain Slice Template + §2.24.7 Round 5 pre-open required checks + §2.25 Encounter / Service Occurrence Container Doctrine + `05_preopen_service_occurrence_checkpoint.md` + §2.17 Provider Clinical Context Packet forward-reference + Amendment J(a) substrate evaluation + DL-20 inv 33-44 + §2.15 Context Module Layer + §2.22 Amendment K resolution log |
| 5.1 | Round 5 closure-prep consistency report | [05_closure_prep_consistency_report.md](05_closure_prep_consistency_report.md) | Round 5 | AUTHORED (decision-prep) | — | K decision memo + terminology audit + substrate gap ledger + scenario reduction + D6/D7 inheritance notes | Use this report before any Round 5 closure attempt; does not itself close Round 5 |
| 5.2 | K(C) minimal implementation lock + D5 substrate closure decisions | [05_2_kc_minimal_implementation_lock.md](05_2_kc_minimal_implementation_lock.md) | Round 5 | AUTHORED (closure-execution prep) | — | Locks K(C) minimal substrate, resolves `encounter_line` transition posture, decides link/segment Day 0 posture, and locks appointment->occurrence bridge semantics | Execute amendment mapping + §2.22.4 resolution entry + unresolved blocker check before closure |
| 5.3 | Round 5 closure verdict | [05_3_round5_closure_verdict.md](05_3_round5_closure_verdict.md) | Round 5 | AUTHORED (closure verdict) | — | Records Amendment K path A resolution, formal DL amendment-entry completion, and K-blocked scenario resolution status | Design/doctrine closure only; Round 6/7 and final validation still required |
