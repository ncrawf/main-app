...
| 6 | **Intake / Patient-Source** | `contracts/intake_contract.md` | ▶ **NEXT** | intake construction + clinical-assertion designs + intake audits; §7.5.3 patient-source; CNS seam (intake→CNS) |
