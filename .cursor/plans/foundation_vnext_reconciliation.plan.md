...
| 9 | **RBAC / Authority / Attestation** | `contracts/rbac_authority_contract.md` | ▶ **NEXT (native draft)** | DL-18 LOCKED (likely clean-into-contract) + grep legacy §1J authority sections; absorbs the `REV-169` consent/authority-enforcement slice + the staged 4-tier provider attestation (scheduling/D5 cluster) + Federation grants COMPOSE with RBAC atoms. Native single-pass |
