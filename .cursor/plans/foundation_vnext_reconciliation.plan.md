...
| 4 | **CNS / Orchestration** | `contracts/CNS_orchestration_contract.md` | ▶ **NEXT** — ⏳ **prereq:** recover LI doctrine + CNS slice off-main `d753a64` (`D0THES-CNF-010` + `REV-148` branch manifest) | CNS ADR + DL-14/16 + rules/templates §1Q |
