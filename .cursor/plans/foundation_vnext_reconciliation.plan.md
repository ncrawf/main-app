...
| 3 | **D3 Scheduling / Appointment** | `contracts/D3_scheduling_contract.md` | ▶ **NEXT** — partial (appointment substrate already moved here via D5 disposition; references Identity `patient`/`patient_relationship`) | DL-20 inv 33-34/38-40/42 + `day_0_scheduling_rule_matrix` |
| 4 | **CNS / Orchestration** | `contracts/CNS_orchestration_contract.md` | ⏳ **prereq:** recover LI doctrine off-main `d753a64` (`D0THES-CNF-010`) | CNS ADR + DL-14/16 + rules/templates §1Q |
| 5 | **Messaging / Communications** | `contracts/messaging_contract.md` | ⏳ | communications_topology + external-line; `D0W3B-GRD-001` external-line-collapse |
