...
| 10 | **Settings / Catalog / Registry** | `contracts/settings_catalog_contract.md` | ▶ **NEXT (native draft)** | DL-19 LOCKED. Lands the staged `pathway_sensitivity` declaration (`SC-SET-MSG-001`, privacy/comms) + service/catalog definitions (D3/D6 consume) + venue/offer/campaign catalog + permeability-policy hosting (Federation defines shape, Settings hosts values). Native single-pass |
