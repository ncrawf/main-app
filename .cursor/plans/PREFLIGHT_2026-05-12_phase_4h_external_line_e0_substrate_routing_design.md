...
**Doctrine inheritance:** DL-10 (identity/relationship), DL-11 (three messaging surfaces), DL-12 (lifecycle/fax/AI/template/search/visibility/notification/attachment/queue/coexistence/AI-Response-Assist), Radar Zone 68 (single-rail marketing+clinical concentration forbidden).
**Doctrine introduced:** NONE — every clause in this preflight inherits from existing doctrine and EXTENDS it to external-line operator workflows.
**Preflight planning trail:** R1-R9 pressure-test trail captured in the agent transcript record (operator-parity / contact-identity / phone-system / settings / multi-brand / display-identity rounds); R9-stable plan approved 2026-05-12 11:30 prior to drafting this document. No in-repo trail file — context flows from approved R9 plan directly into this preflight.
...
| **Radar Zone 68 — Single phone-number rail shared by marketing + clinical/operational SMS** | [v1_pressure_test_radar.md](../../docs/architecture/v1_pressure_test_radar.md) Zone 68 | Per-endpoint `intent_class` typing is substrate-binding; single-rail marketing+clinical SMS is forbidden; default recommendation is two-number minimum (one clinical/operational, one marketing); admit N-number scale without rebinding. |
...
| **Pressure test radar — relevant existing zones** | [v1_pressure_test_radar.md](../../docs/architecture/v1_pressure_test_radar.md) | Zones 1, 17-25, 27-28, 30, 47-48, 53, 54, 56, 58, 59, 61, 63-68 all apply or are inherited; §19 lists potential new zones surfaced by e1+ execution. |
...
- [MAIN system map](system_map_three_layers_60706286.plan.md) — DL-10, DL-11, DL-12 binding locks; §1D.3, §1G.1-§1G.11, §1J.12, §1N.8, §1P, §1Q.14 + §1Q.21 + §1Q.23, §1V.10 sections.
- [FOUNDATIONAL_ARCHITECTURE_2026-05-10_all_dimensions.md](FOUNDATIONAL_ARCHITECTURE_2026-05-10_all_dimensions.md) — §4.A primitives (#1, #10, #16), §5.3 sibling boundary guards, §7.13 + §7.13.12, §7.14 + §7.14.9-10-18, §8.1, §11.0 crosswalk.
- [phase_4h_target_first_decision_record.md](../../docs/architecture/phase_4h_target_first_decision_record.md) — ADR §7.10, §7.13, §7.14, §7.15.
- [communications_topology.md](../../docs/architecture/communications_topology.md) — §11 external-line gap + DL-10 substrate spine; §12 internal collaboration + DL-12 cross-references; §13 fax canonical placement.
- [v1_pressure_test_radar.md](../../docs/architecture/v1_pressure_test_radar.md) — Zone 1, Zone 17-28, Zone 30, Zone 35, Zone 47-48, Zone 53-54, Zone 56, Zone 58-59, Zone 61, Zone 63-68.
- [evolution_narrative.md](../../docs/architecture/evolution_narrative.md) — Act X (doctrine reconciliation arc).
...
This preflight is PROPOSED as of 2026-05-12. Activation to e1 requires:
1. Reviewer pass (architecture + clinical + compliance).
2. Doctrine cross-reference annotations in [communications_topology.md](../../docs/architecture/communications_topology.md) §11 + §13 — to be performed in e1 commit (not in e0).
3. Substrate-reality re-audit at e1 start (re-verify nothing has landed between e0 PROPOSED and e1 activation that would foreclose design decisions).
