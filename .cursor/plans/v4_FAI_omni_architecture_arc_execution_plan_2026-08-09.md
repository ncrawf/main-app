...
**Recovery is evidence reconstruction, not ratification.** Establishing what the estate previously said, what was accepted versus merely proposed, what was actually implemented, and what later work narrowed or superseded is protection against re-deriving months of work. **It establishes nothing about whether the recovered material is good.** A recovered proposition may be **preserved · sharpened · narrowed · relocated · superseded · rejected · or retained only as evidence**, and **ten stale documents do not outvote one better argument.**
...
| **Operator direction** | establish strategic intent, product posture, priorities, unacceptable outcomes, new questions | manufacture clinical, legal, technical or architectural truth by fiat |
...
| **External primary material** | supply mechanisms, standards, formal constraints, operating precedent, negative controls | import its native ownership, economic, liability and authority assumptions |
| **Informal material** — forum, anecdote, report | reveal operator pain, failure modes, deployment surprises, anti-patterns, search leads | carry a load-bearing architecture claim without stronger corroboration |
