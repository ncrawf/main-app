...
flowchart TB
    ...
    OBS --> ER["extraction_run<br/>AI/rule/policy-driven<br/>model_version pinned"]
    ER --> AS["extracted_assertion<br/>confidence, polarity,<br/>uncertainty,<br/>contradiction_flag,<br/>requires_confirmation,<br/>requires_clinician_review"]
    ...
    RES --> AUTH["authorized_action<br/>actor authority verified<br/>scope checked, audited"]
    AUTH --> EXE[execution]
