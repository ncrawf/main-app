...
Status: `draft_for_review` 2026-06-05
...
| 4 | **REV-176 routing spine + inventory** | `ai_substrate_routing_spine_REV-176.md` + `ingestion/ai_substrate_2026/inventory/` (7 clusters on disk; 5 stragglers pending) | the anti-compression source: ~630 source-anchored concepts, landing-zone routing, net-new primitives, reread flags, stale/affirm flags | evidence_nonbinding |
...
The full concept inventory (`ingestion/ai_substrate_2026/inventory/` — 7 clusters on disk, 5 stragglers pending quota reset) is **tracked, non-blocking-but-not-optional**; the integrated v3 §16 + §18 **back-reference REV-176 + the inventory** so the 47 sources are recoverable, never "vaporized into five sentences."
