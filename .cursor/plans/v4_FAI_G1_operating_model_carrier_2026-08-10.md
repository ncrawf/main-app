...
Status: **`g1_carrier_R8.5b · state=proposed · B-1_CLEARED · OUTPUT_1_ACCEPTED_AS_G1_PROPOSAL__1_OF_8_COMPLETE · AB-08_CLOSED_adopted_narrowed · AB-08_SEMANTIC_DISPOSITION_ACCEPTED__LEDGER_RECEIPT_PENDING · three_binding_carries_recorded · 0_of_8_outputs_complete`**
...
**Owed follow-up, not landed here:** the checkpoint's two derived counts, in a checkpoint transaction by its rightful writer. **Nothing else in the estate depends on them.**

## §8 — STOP RECEIPT

| Field | Value |
|---|---|
| Artifact | FAI **G1 operating-model carrier R8.5b · OUTPUT-1 ACCEPTANCE LANDED 2026-08-13** · seat `proposal_authoring` · state **`proposed`** · **`B-1` CLOSED 2026-08-11** |
...
| Next | **The acceptance transaction is LANDED (§7.5).** Remaining, in order: ① **verify this landing's bounded diff**, after which **this `integration` grant EXPIRES** · ② the checkpoint's two derived counts are repaired by their **rightful writer** (`§7.5.1`) · ③ **Output 2 opens in a FRESH context** and nothing else in G1 proceeds in this one · ④ **Output 2's first executable proof is the propagation defect this arc produced ELEVEN times — the eleventh in its own acceptance transaction:** one canonical change → impact traversal → required decisions → accepted update → **regenerated projections** → divergence detection → correction work item → verification receipt. **No loop diagram earns credit without that.** |
...
**STOP: `g1_carrier_R8.5b · OUTPUT_1_ACCEPTED_AS_G1_PROPOSAL__1_OF_8_COMPLETE · accepted_head_480f3bbb2a63d81dec4b091d3cd5871e3ddd4e83 · AB-08_adopted_narrowed_LANDED_ledger_open_7_to_6 · B-3_and_G-08_CLOSED · B-8_B-13_B-15_PRESERVED · zero_new_M2_primitives · zero_semantic_change_in_this_landing · checkpoint_UNCHANGED_two_derived_counts_stale_and_DECLARED_at_7.5.1 · route_9v-ii_conditional_unchanged · no_read_graph_promotion · PR_17_draft · integration_grant_expires_on_verification · G1_NOT_accepted_or_closed · output_2_not_started`**
