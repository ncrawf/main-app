# v4 — FAI — G1 OPERATING-MODEL CARRIER (R8.5)
...
Status: **`g1_carrier_R8.5 · state=proposed · B-1_CLEARED · OUTPUT_1_AMM_C4_1_STRUCTURAL_PROOFS_CORRECTED__READY_FOR_DIFF_ONLY_REVIEW · AB-08_SEMANTIC_DISPOSITION_ACCEPTED__LEDGER_RECEIPT_PENDING · three_binding_carries_recorded · 0_of_8_outputs_complete`**
...
| Field | Value |
|---|---|
| **Output 1** | **`AMM_C4_1_STRUCTURAL_PROOFS_CORRECTED · READY_FOR_DIFF_ONLY_REVIEW`**, bounded by `§E12.7`. **R8.4's “discharged / conditionally accepted” is withdrawn.** **The stopping test, applied and reported: all four corrections are representable with the existing resource, decision, relation, context and facet families — ZERO new M2 primitives, and the resource/revision/descriptor/carrier model is untouched.** That is the honest end of this cycle rather than an end by fatigue |
| **`AB-08`** | **`ACCEPTED_IN_SUBSTANCE__PENDING_OPERATOR_STEWARD_RECEIPT`** |
...
An origin-accepted assertion may still be not locally admitted · outside the selected profile · inapplicable to the deployment, jurisdiction or mission · admitted only as evidence · blocked by non-loosening · locally superseded · **or contested but still effective.** **Outputs 3 and 5 own precedence, conflict, applicability evaluation, non-loosening, profile composition and the resolution algorithm.** Rejected, disputed and withdrawn edges remain visible as evidence and history.
...
>                         with ITS OWN accepted | rejected | revoked | conditional state
>         ↓ derived
...
**STOP: `g1_working_dossier_R8.5 · B-1_CLOSED_2026-08-11 · 40_rows_verdicted_zero_closed · OUTPUT_1_AMM_C4_1_STRUCTURAL_PROOFS_CORRECTED__READY_FOR_DIFF_ONLY_REVIEW · R8.4_discharged_and_conditionally_accepted_WITHDRAWN · global_unambiguity_is_NOT_global_sovereignty · origin_state_ISSUER_scoped__local_admission_is_a_SEPARATE_applicability_decision · dispute_is_an_ORTHOGONAL_challenge_not_a_state_value · resolver_conditions_NECESSARY_not_sufficient · digest_needs_descriptor_plus_constituents_plus_manifest_plus_canonicalization · zero_new_M2_primitives · AB-08_SEMANTIC_DISPOSITION_ACCEPTED__LEDGER_RECEIPT_PENDING · route_9v-ii_conditional · G1_CONTRACT_0_of_8_outputs_complete · output_2_not_started`**
