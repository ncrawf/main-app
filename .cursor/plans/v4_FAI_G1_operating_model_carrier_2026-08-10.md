...
Status: **`g1_carrier · state=proposed · B-1_CLEARED · OUTPUT_1_ACCEPTED_AS_G1_PROPOSAL__1_OF_8_COMPLETE · OUTPUT_2_PROPOSED_NOT_ACCEPTED → §E13 · AB-08_CLOSED_adopted_narrowed · AO_SELF_FIXTURE_ACTIVE → §E13.26 · G1_INCOMPLETE`**
...
| Field | Value |
|---|---|
| Artifact | FAI **G1 operating-model carrier** · Output 1 `ACCEPTED_AS_G1_PROPOSAL` · Output 2 `PROPOSED · NOT_ACCEPTED` (`§E13`) · seat `proposal_authoring` · state **`proposed`** · **`B-1` CLOSED 2026-08-11**. *(No revision label: correction rounds are the rows below.)* |
