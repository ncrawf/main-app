...
| **Control plane after landing** | route `9v-ii` **conditional/proposed, unchanged** · **checkpoint repointed** for current state and next output (permitted by this grant) · catalog row synchronized · PR #17 **draft** |
