# v4 — FAI — G1 OPERATING-MODEL CARRIER (R8.5b)
...
Status: **`g1_carrier_R8.5b · state=proposed · B-1_CLEARED · OUTPUT_1_AMM_C4_1_READY_FOR_OPERATOR_STEWARD_ACCEPTANCE · AB-08_SEMANTIC_DISPOSITION_ACCEPTED__LEDGER_RECEIPT_PENDING · three_binding_carries_recorded · 0_of_8_outputs_complete`**
...
| Field | Value |
|---|---|
| **Output 1** | **`AMM_C4_1_READY_FOR_OPERATOR_STEWARD_ACCEPTANCE`**, bounded by `§E12.7`. **R8.4's “discharged / conditionally accepted” is withdrawn.** **The stopping test, applied and reported: all four corrections are representable with the existing resource, decision, relation, context and facet families — ZERO new M2 primitives, and the resource/revision/descriptor/carrier model is untouched.** That is the honest end of this cycle rather than an end by fatigue |
| **`AB-08`** | **`ACCEPTED_IN_SUBSTANCE__PENDING_OPERATOR_STEWARD_RECEIPT`** |
...
| Field | Value |
|---|---|
| Artifact | FAI **G1 operating-model carrier R8.5b** · seat `proposal_authoring` · state **`proposed`** · **`B-1` CLOSED 2026-08-11** |
...
**STOP: `g1_working_dossier_R8.5b · B-1_CLOSED_2026-08-11 · 40_rows_verdicted_zero_closed · OUTPUT_1_AMM_C4_1_READY_FOR_OPERATOR_STEWARD_ACCEPTANCE · global_unambiguity_is_NOT_global_sovereignty · origin_state_ISSUER_scoped__local_admission_is_a_SEPARATE_applicability_decision_pinning_the_exact_origin_REVISION · dispute_is_an_ORTHOGONAL_challenge_not_a_state · absence_is_TYPED_ABSENCE__not_determined_is_a_DERIVED_projection__denied_needs_an_attributed_decision · resolver_conditions_NECESSARY_not_sufficient · decision_outcome_≠_disposition_≠_condition · digest_needs_descriptor_plus_constituents_plus_manifest_plus_canonicalization · zero_new_M2_primitives · AB-08_SEMANTIC_DISPOSITION_ACCEPTED__LEDGER_RECEIPT_PENDING · route_9v-ii_conditional · checkpoint_unchanged · G1_CONTRACT_0_of_8_outputs_complete · output_2_not_started`**
