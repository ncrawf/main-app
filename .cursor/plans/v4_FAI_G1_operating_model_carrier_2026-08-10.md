...
| `RelationConstraint` | constrained subject / type / set references · `binding_site` · scope |
| `CompositionRule` | ordered `input_type_revision_refs` · declared output relation or result semantics · scope |
...
|---|---|
| **`owns`** | **REJECTED as a relation type.** It is a god-predicate over four distinct facts the estate has already decomposed — **semantic commit authority ⟂ accountable ownership ⟂ stewardship/custody ⟂ canonical carrier** (`§E13.7`) — and the eight-relation governance grammar (`§E9.3`) resolves it further into steward, scoped semantic authorities, maintainers, approval policy, review requirements, integration authority, enforcement and holder register. **Adopting `owns` would regress an accepted Output-1 and Output-2 decomposition.** Every use resolves to the exact governance relation meant |
| **`depends_on`** | **Accepted** as an architecture-plane coordination type. Direction is supplier→consumer-sensitive per `D0CKPT-GRD-005`; `blocks_start` ⟂ `blocks_close` are distinct types over the same pair, not one edge |
| **`specializes`** | **Accepted**, carrying the pinned-base non-loosening **declaration** of `§E14.4.4`. It may never relax an inherited prohibition; the check is validator-checkable against the pinned base, not self-enforcing |
| **`supersedes`** | **Accepted** as an explicit typed lineage relation — `§E7.1.2`'s six-condition transaction, **never a scalar comparison**, and `superseded` remains derived rather than asserted |
| **`conforms_to`** | **Accepted** as a relation type. **Conformance *evaluation* remains Output 6**; the relation only states that conformance is claimed against a target |
| **`implemented_by`** | **Accepted** with honest representational cardinality **`0..n`** — Output 1 already corrected the `1:n` form that implied every resource has an implementation |
...
**Assertion grain, inherited from `AB-15`/`INV-17`** `[INH]`: **a `RelationAssertion` is an *atomic statement* with one issuing principal** — many actors, signers, witnesses or dissents may participate without making the assertion a collective act. **Collective decisions about constraints, composition or conflict are separate composite acts** with their own identity, named body, decision rule and **independently attributable constituent acts** — they are objects 4 and 5, or Output-4 manifests, never a multi-principal assertion. **Participation and multiple signatures do not turn one assertion into a collective principal.** `AB-15` is `adopted_narrowed` with `INV-17` marked `blocks G1`, so this is discharge of an inherited obligation at relation grain, not a new rule.

**Local admission** is object 3 and is separate `[INH §E12.7.2 / `G1-FIND-46`]`. It is issued **by the receiving scope**, references the **exact origin assertion revision**, and carries its own decision state, outcome and conditions, disposition and effective interval. It does not rewrite the origin.
...
LOCAL ADMISSION       B's attributed, effective-dated decisions, each over an exact
                      revision-pinned target of a DECLARED class (§E14.3.1)
        ↓ derived
B'S EFFECTIVE GRAPH = join( origin-valid assertions,
                            ACTIVE admission of the PREDICATE SEMANTICS (type or mapping),
                            ACTIVE admission/applicability of the ASSERTION revision,
                            in-interval, in-scope, not blocked by constraint )
```

**Necessary, not sufficient** `[INH]`. An origin-accepted assertion may still be unadmitted, **carry a predicate whose meaning was never admitted or mapped**, be outside the selected profile, inapplicable to the deployment or mission, admitted only as evidence, blocked by a constraint, locally superseded, or contested and still effective.
...
| `RelationConstraint` revision | recorded time **+** effective interval **where it carries normative force** |
...
## §E14.6 — Conflict, challenge, stay, adjudication and precedence references

**`conflicts_with` may be a relation. The governed conflict is object 5** `[KND]`, carrying: identity · participating assertions · conflict type · scope · detection basis · evidence · owner · adjudicating authority · governing policy · status · stay or interim posture · decision · effective time · reopening · resolution lineage.
...
| R34 | ownership edge from a P4/P5 resource to canonical truth | the edge | `T0-15`, `D0THES-DEC-033` | reject — while `owns_definition` **remains permitted** |
...
**STOP: `g1_carrier · OUTPUT_1_AND_OUTPUT_2_ACCEPTED_AS_G1_PROPOSALS__OUTPUT_3_PROPOSED_NOT_ACCEPTED__2_OF_8_COMPLETE · OUTPUT_3_§E14_AUTHORED_THEN_R1_R2_R3 · R3_SEMANTIC_CLOSURE_AFTER_INDEPENDENT_ARTIFACT_FIRST_SANITY_REVIEW · CONSTITUTIONAL_SHAPE_AND_SIX_OBJECT_MODEL_INDEPENDENTLY_RECONSTRUCTED_AND_HELD · ADMISSION_HAS_A_TARGET_CLASS_SEMANTICS_⟂_MAPPING_⟂_INSTANCE_§E14.3.1 · META_KERNEL_TERMINATED_FOR_OBJECTS_3_TO_5_AS_M2_DECLARED_STRUCTURAL_FIELDS_§E14.1.3 · TEMPORAL_CONTRACT_BY_OBJECT_PHYSICS_NOT_ONE_UNIVERSAL_FIELD_SET_§E14.5 · CROSS_OWNER_CONSTRAINTS_NEED_A_DECISION_CONDITION_NO_STEWARD_FALLBACK_§E14.4.1 · PLAN_§3.1_RELATIONS_RECONCILED_owns_REJECTED_AS_A_TYPE_§E14.2.2 · ASSERTION_IS_AN_ATOMIC_STATEMENT_AB-15_GRAIN · CONSEQUENCE_CLASSES_DISTINGUISHED_REJECT_IS_NOT_ONE_OUTCOME · MODEL_SECTIONS_STATE_CURRENT_LAW_ONLY_INLINE_NARRATIVES_STRIPPED · CARRY_STATE_OWNED_BY_§E14.9.6_ALL_CONDITIONAL_ON_ACCEPTANCE · OUTPUT1_VALUE_SETS_REMAIN_CAN_PROHIBITION_STATED_SEMANTICALLY · superseded_IS_DERIVED_FROM_A_RELATION_NEVER_ASSERTED · REVISION_POSTURE_SPLIT_COMPATIBILITY_⟂_REQUIRED_TREATMENT_⟂_SUPERSESSION · INTERIM_MEASURE_⟂_INTERIM_EFFECT_A_STAY_IS_ONE_MEASURE_NOT_THE_GENUS · IDENTITY_TRANSITION_RECORDED_66_67_68_→_67_68_69 · NO_SOVEREIGN_GRAPH_INVARIANT_INHERITED_FROM_GOVERNING_CARRIERS_T0-13_T0-14_T0-15_DEC-033_GRD-026_GRD-035_D0CKPT-GRD-005_4WAY_AUTHORITY_COMPOSITION · SIX_OBJECT_REALIZATION_IS_CANDIDATE_SYNTHESIS · EVSRC-2026-000270_IS_CLASS_D_EXTERNAL_EVIDENCE_NO_FORCE_RAW_ANCHOR_REOPENED · INV-19_AND_INV-21_ARE_UNACCEPTED_PRE-0_CANDIDATES_NOT_INHERITED_LAW · AB-13_IS_AN_INDEX_NOT_AN_AUTHORITY · FOUR_PROVENANCE_CLASSES_GOVERNING_⟂_ACCEPTED_AS_PROPOSAL_⟂_CANDIDATE_⟂_EXTERNAL · STEWARD_OWNED_RELATION_REGISTRY_WITHDRAWN_G1-FIND-67 · SIX_OBJECTS_DO_NOT_COLLAPSE · RELATION_TYPE_OWNERSHIP_FOLLOWS_SCOPE_OF_MEANING · CATALOG_OWNS_NO_SEMANTICS · CONSTRAINTS_DECLARE_A_BINDING_SITE · REPRESENTATIONAL_⟂_CONFORMANCE_CARDINALITY_PRESERVED · EXCLUSIVITY_IS_A_CONSTRAINT_SURFACE_NOT_A_PAIRWISE_FLAG · COMPOSITION_IS_TYPED_OVER_PAIRS_NOT_A_BOOLEAN · AUTHORITY_NEVER_PROPAGATES_BECAUSE_A_PATH_COMPOSES · NO_UNINSPECTED_CLOSURE · D0CKPT-GRD-005_VALUES_NOT_UNIVERSALIZED · RELATION_BITEMPORALITY_PROPOSED_RESOLUTION_WOULD_DISCHARGE_A_CAN→3_ON_ACCEPTANCE · NO_ACCEPTED_CARRY_DISCHARGED_BY_AUTHORING · NO_HINDSIGHT_BINDS_THREE_MODES_NOT_FOUR · INVALIDATION_IS_A_PREDICATE · CONFLICT_IS_A_RESOURCE_NOT_AN_EDGE_STATE · PRECEDENCE_IS_A_REFERENCE_NEVER_A_SCALAR · SIX_RESOLVABILITY_CLASSES_IDENTITY_⟂_LOCATOR · REALIZES_CHOSEN_EMBODIES_WITHDRAWN · ALIAS_CONDITIONAL_UNIQUENESS_INHERITS_HANDLE_≠_PERSON · CESSATION_CHANGES_RELATIONS_NOT_IDENTITY · REJECTION_MATRIX_§E14.8.1_IS_THE_AUTHORITATIVE_ROW_SET_NO_COUNT_MAINTAINED · GENERATED_PROJECTIONS_ARE_NOT_OWNERLESS · RELATION_TYPE_REVISION_NEVER_SILENTLY_REINTERPRETS_PRIOR_ASSERTIONS · CROSS_OWNER_COMPOSITION_NEEDS_A_DECISION_CONDITION_NO_STEWARD_FALLBACK · FOUR_CONFLICT_MOMENTS_DO_NOT_COLLAPSE · ALIAS_BINDINGS_CARRY_ISSUER_AND_ANTI_EQUIVOCATION · NON_LOOSENING_IS_VALIDATOR_CHECKABLE_AGAINST_A_PINNED_BASE_NOT_SELF_ENFORCING · normative_effect_⟂_epistemic_role_NOT_RECOLLAPSED · M-106_PROVES_EXISTENCE_NOT_AUTHORITY · M-106_RUN_ONE_ANCHOR_REOPENED_NO_NOVELTY_COUNT_MAINTAINED · FRONTIER_ONE_HONEST_current_practice_only_ADMISSION_REVIEW_AT_MACHINE_SCALE · FINDINGS_AUTHORITATIVE_IN_§7.3_NO_RANGE_MAINTAINED · §6.1_EDGE_KIND_SET_NAMED_NOT_REPAIRED · NO_GRAPH_TECHNOLOGY_NAMED · NO_VALIDATOR_WRITTEN · NO_CONSTRAINT_LANGUAGE · NO_DEPENDENCY_GRAPH_SUBSYSTEM · L1_GRAMMAR_STAYS_ROUTED_TO_FEDERATION · REVIEW_ARTIFACTS_STAY_ROUTED_TO_BUILD_OS · OUTPUT_1_AND_2_BYTES_UNCHANGED · OUTPUT_2_RECEIPT_§7.6_ACCEPTED_HEAD_a37a3184_BLOB_1fa76c9d · ACCEPTED_§E13_BYTES_SHA256_VERIFIED_UNCHANGED · THREE_ACCEPTANCE_FUNCTIONS_EXERCISED_SEPARATELY · OTHER_DOMAIN_OWNERS_NOT_APPLICABLE_NOT_OMITTED · INTEGRATION_GRANT_MINISTERIAL_AND_EXPIRED_ON_VERIFICATION · B-15_NARROWED_TO_OUTPUTS_3_TO_7 · §E13.24_STATUS_LINE_PINNED_RESIDUAL_DECLARED_§7.6 · LEDGER_287_DISCHARGED_2026-08-15_AT_a4c88d3 · OUTPUT_3_AUTHORED_AND_PROPOSED_§E14 · AO_SELF_FIXTURE_ACTIVE → §E13.26 · FUNCTION_MAP_SEALED_TO_THREE_LEVELS · EVIDENCE_ADMISSION_SPLIT_INTO_THREE_IDENTITIES · SUCCESSOR_CONTEXT_OBEYS_WORKING_PACKET_LAW · LOGICAL_DEDUP_IS_NOT_PHYSICAL_STORAGE_LAW · INDEPENDENCE_RATINGS_ARE_SELF_ASSESSED_EVIDENCE_NOT_ASSESSMENT · HUMAN_CONTRIBUTION_FIRST_CLASS_NOT_AUTHORITATIVE · DOWNSTREAM_CARRIES_ROUTED · AGENT_RUNTIME_DEDUP_RUN_MOST_OF_RUN_CONTEXT_EXISTS_AS · OPERATING_SIGNATURES_THREE_LEVELS_ACT_OBLIGATION_EXECUTION_FORM · EFFECT_IS_NOT_ITS_AUTHORIZING_COMMITMENT · ADMISSION_RECOGNIZES_DOES_NOT_ORIGINATE_AUTHORITY · INDEPENDENCE_SEVEN_AXIS_PROFILE_SOME_AXES_UNOBTAINABLE_INTERNALLY · RELATIONSHIP_MODE_DISCLOSURE_AXES_SPLIT · CONTEXT_ENVELOPE_BOUNDED_WITH_UNKNOWN_POSTURE · WORK_ASSIGNMENT_RUN_CLAIM_CONTEXT_CLOCKS_ORTHOGONAL · RELAY_GRAPH_ONE_PAYLOAD_MANY_DELIVERIES · INDEPENDENT_REALIZATION_IS_NOT_A_DERIVATIVE · RIGHTS_SCOPED_NOT_SCALAR · NO_SCHEDULER_MINTED · NO_MUSIC_VOCABULARY · TRIFECTA_IS_A_DERIVED_VIEW · AB-08_adopted_narrowed · B-3_and_G-08_CLOSED · B-8_B-13_remaining · B-15_NARROWED_TO_OUTPUTS_3_TO_7 · AB-08_FIXTURE_FROZEN_AT_50431e32851086acbbd9f4534e2cec7e7f4b5f49 · AO-SELF-1_FIXTURE_FROZEN_AT_ee1fa6e05b4313e49aa361e75a2dea11b491de18_blob_3b6b49f43a84a481084f7f1ea28831f4fa455c30 · ledger_287_repair_DISCHARGED_IN_ITS_OWN_BOUNDED_TRANSACTION_at_a4c88d3_historically_owed_at_earlier_heads · AB-08_ambiguity_set_ENUMERATED_BY_IDENTITY_five_sites_two_tokens_UNDECIDED · verbatim_set_ENUMERATED_AND_PINNED_no_hand_count_survives · PLATFORM_ACCOUNTABILITY_CONTROLLING_SEAMS_VERIFIED_FOR_OUTPUT2_ACCEPTANCE · B-8_BROADER_SOURCE_FLOOR_REMAINS_OPEN · FO-6_ANSWERED_CLOSES_ON_ACCEPTANCE · CATALOG_SYNCHRONIZED · ROUTE_9v-ii_UNCHANGED_ITS_PROMOTION_CONDITION_DID_NOT_FIRE · PR_17_draft · G1_INCOMPLETE · outputs_4_to_7_not_started · B-15_narrows_on_acceptance_not_authorship · B-8_UNCHANGED · one_file_changed · no_checkpoint_no_catalog_no_read_graph_no_ledger_no_FWREG_no_contract_no_code_no_workflow_no_new_artifact · route_9v-ii_unchanged_promotion_condition_did_not_fire · no_standing_integration_grant · NOT_SELF_ACCEPTED`**
