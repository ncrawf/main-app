...
Status: **`g1_carrier · state=proposed · B-1_CLEARED · OUTPUT_1_ACCEPTED_AS_G1_PROPOSAL · OUTPUT_2_ACCEPTED_AS_G1_PROPOSAL → §E13 · 2_OF_8_COMPLETE · AB-08_CLOSED_adopted_narrowed · AO_SELF_FIXTURE_ACTIVE → §E13.26 · G1_INCOMPLETE`**
...
| **B-15** | **★ NARROWED 2026-08-14 — `§G1-CONTRACT` outputs 3–7 only.** The operations loop is **accepted as a G1 proposal** (`§E13`, receipt `§7.6`); that component of `B-15` is discharged. Remaining: graph semantics, change lifecycle, profile resolution, conformance model, transfer-limit matrix | R8 §5 `G1` |
...
| Field | Value |
|---|---|
| Artifact | FAI **G1 operating-model carrier** · Output 1 `ACCEPTED_AS_G1_PROPOSAL` · **Output 2 `ACCEPTED_AS_G1_PROPOSAL` (`§E13`, receipt `§7.6`)** · **2 of 8 complete** · seat `integration` **expired on verification** · carrier state **`proposed`** · **`B-1` CLOSED 2026-08-11**. *(No revision label: correction rounds are the rows below.)* |
