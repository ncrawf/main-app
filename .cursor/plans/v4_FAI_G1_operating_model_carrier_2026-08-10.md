...
| **Still owed, deliberately outside this transaction** | **`ledger:287`** — the PRE-0 ledger's *"7 rows remain legitimately open"* against a canonical 6. A separate rightful bounded correction transaction, owed promptly, **not smuggled into this landing** |
