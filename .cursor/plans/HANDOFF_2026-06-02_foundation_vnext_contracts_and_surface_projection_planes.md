...
3. **Alias merges:** admin vs ops vs IT console; provider profile vs workspace vs task; marketing dashboard vs campaign-performance console — decide split vs merge.
