...
| User / operator research | `user_operator_research/` | interviews, feedback, support themes, staff/provider/customer operational pain | **live** (first source `EVSRC-2026-000200` 2026-07-05; index `user_operator_research/00_index.md`) |
