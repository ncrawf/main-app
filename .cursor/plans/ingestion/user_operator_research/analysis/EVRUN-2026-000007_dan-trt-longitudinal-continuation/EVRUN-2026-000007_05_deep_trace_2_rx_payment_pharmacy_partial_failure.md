...
Document type: `evidence_or_ingestion` (Evidence Plane · `user_operator_research` lane · analysis trace) · Authority: `analysis_nonbinding` (`GRD-036`). **Propose-only. Pre-spine. Nothing promoted. Care frozen. 07-12 gate untouched. `active_debate_not_closure`.**
