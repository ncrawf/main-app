...
## Notes
- Next global ids: highest `EVSRC` across the whole Evidence Plane = **`000256`** (wave-4 video scaffolds `000253…000256` created 2026-07-11 in `outside_learning/sources/2026-07_wave-4/`). **`EVSRC-2026-000252` is now FILLED** (the Task-A care-physics "Dan" specimen — captured 2026-07-11; the reserved gap is closed). Any *other* new source scans the whole Evidence Plane +1 (= `000257`). Highest `EVRUN` = `EVRUN-2026-000004` (next = `000005`).
