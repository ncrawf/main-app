...
- evsrc_id: `EVSRC-2026-000265`  ·  filename: `EVSRC-2026-000265_TK.md` *(rename to `_<slug>` at processing)*
...
## §5 — Change log
- `2026-07-11` — wave-4 scaffold created (id `EVSRC-2026-000265`, provisional `_TK` slug); awaiting Nick transcript + Knox-read + URL paste.
