...
> Wave-6 scaffold (`EVSRC-2026-000309_stripe-homepage-redesign-design-review.md`); firm slug at processing (id = highest EVSRC + 1). Row in `../../00_index.md`.
>
...
> **⚠️ MIS-PASTE / NO MATCHING KNOX READ.** The §1 transcript is a **"Design Review" podcast interview with Katie Dill (Stripe Head of Design) on the new Stripe homepage**. The §3 Review 001 block pasted below is a **DIFFERENT source** — Knox's read of **Christopher Batey, "Building Product Teams in the Age of AI"** (self-labeled `EVSRC-2026-000296`) — which does NOT correspond to this transcript. **This source therefore has NO matching Knox §3 Review 001** → processed **transcript-native at reduced depth** per pipeline doctrine. The Batey Knox read was NOT imported/formalized here; it should be re-homed to its correct Batey EVSRC by the parent/operator. **NO screenshot dropped → identity fields `inferred`.** Canonical id = `EVSRC-2026-000309` (filename).
- evsrc_id: `EVSRC-2026-000309`  ·  filename: `EVSRC-2026-000309_stripe-homepage-redesign-design-review.md`  *(firm-slug SUGGESTION, not renamed: `EVSRC-2026-000309_stripe-homepage-redesign-ai-design-craft.md`)*
- source_platform: `YouTube` (inferred)  ·  source_url: `unknown` (no screenshot)  ·  source_title: `Design Review — Katie Dill on Stripe's new homepage / how AI is changing the design process` (inferred from §1)
- channel_or_org: `Design Review (podcast)` (inferred)  ·  speaker: `Katie Dill (Stripe, Head of Design)`  ·  published_at: `unknown` (inferred recent — references Stripe homepage relaunch, stablecoins, agent-experience)
- captured_at: `2026-07-18`  ·  captured_by: `Nick`  ·  capture_method: `transcript paste (screenshot NOT dropped this session)`
- content_type: `interview / podcast (design review / behind-the-scenes craft)`  ·  source_reliability_context: `practitioner` (senior design leader)  ·  topic_tags_light: `[product_UX_features, surface_plane, design_systems, AI_in_design_process, craft_quality_bar, progressive_disclosure, trust_through_outcome, cross_journey_coherence, agent_experience]`

## §0.1 — People / authorship / authority context  *(normalizer fills from screenshot + description + transcript — this is what makes a source a reservoir, not a transcript dump)*
- primary speaker(s):
  - name: `Katie Dill` · role_in_source: `interviewee / guest` · affiliation_at_publication: `Stripe — Head of Design` · speaker_type: `operator` (senior design leader) · authority_context: `Leads Stripe's design org; walks through the 6-years-old (2020) homepage, the >1yr redesign process, the "bento box" progressive-disclosure pattern, AI-generated brand imagery, evolving design systems, and craft/quality discipline ("gravitational pull to mediocrity")` · identity_confidence: `inferred` (from §1 transcript only; no screenshot this session)
  - name: `(host)` · role_in_source: `interviewer / host of the "Design Review" podcast` · affiliation_at_publication: `unknown` · speaker_type: `other` · authority_context: `Frames the design crit; surname not established in §1` · identity_confidence: `inferred`
- publisher / channel: `Design Review (podcast)` (inferred)  ·  interviewer / moderator / host: `Design Review host (unnamed in §1)`
- event_context: `Recorded design-review conversation; behind-the-scenes of Stripe's homepage relaunch + how AI is changing the design process`  ·  perspective / conflict notes: `Practitioner account from Stripe's own design leader — self-reported craft narrative promoting Stripe's design maturity and process; product claims (GDP-share counter, "78% of Forbes AI 50 use Stripe", "walking the store" culture) are self-reported and unverified within the source. Take the design/quality mechanisms; discount the brand-promotion framing (GRD-039).`
...
# EVSRC-2026-000296 — Building Product Teams in the Age of AI: What We Had to Relearn Every Quarter
...
- evsrc_id: `EVSRC-2026-000296`
- filename: `EVSRC-2026-000296_building-product-teams-in-the-age-of-ai.md`
- source_platform: `YouTube`
- source_url: `https://www.youtube.com/watch?v=tJUAef_dBtU`
- source_title: `Christopher Batey - Building Product Teams in the Age of AI: What We Had to Relearn Every Quarter`
...
- content_type: `enterprise product-engineering case study / technical conference presentation`
- source_reliability_context: `practitioner`
- topic_tags_light: `[AI_product_teams, system_thinking, architecture_decisions, path_to_production, product_adoption, cognitive_parallelism, team_topology, blast_radius, vendor_dependency, AI_delivery_principles]`
...
- primary speaker(s):
  - name: `Christopher Batey`
    ...
    · affiliation_at_publication: `Core Engineering Consulting Group — CTO`
    · speaker_type: `operator`
    · authority_context: `Technical and organizational leader describing how a consulting organization became a software-product company while building high-consequence systems with approximately 90–100% AI-generated implementation`
    · identity_confidence: `high_from_screenshot_and_transcript`

  - name: `Katie Roberts`
    · role_in_source: `stage host / introducer`
    · affiliation_at_publication: `AI Native Dev / Latent Space stage`
    · speaker_type: `other`
    · authority_context: `Introduces Christopher Batey and frames the session`
    · identity_confidence: `high_from_transcript`

- publisher / channel: `AI Native Dev`
- interviewer / moderator / host: `Katie Roberts`
- event_context: `AI Native Dev conference presentation on building and restructuring a product-engineering team under rapidly increasing AI-assisted delivery speed`
- perspective / conflict notes: `The source is a direct practitioner account from a consulting and software organization promoting its product-engineering approach. Claims about AI-generated-code percentages, team effectiveness, and organizational results are self-reported. The source is strongest on system-design discipline, product-flow bottlenecks, team topology, human comprehension, and adoption ownership.`

## §2 — Screenshot / visible source details

- visible_duration: `31:02`
- visible_views_at_capture: `613`
- visible_capture_date: `2026-07-19`
- description_context: `Christopher Batey explains how Core Engineering Consulting Group repeatedly redesigned its product-development practices as AI accelerated implementation. The talk focuses on safe paths to production, evaluating AI-enabled engineers, parallel work, architectural boundaries, adoption responsibility, and preserving human systems thinking.`
- system_consequence_context: `The products described manage sensitive enterprise information and customer production environments, making design, authorization, isolation, verification, and recovery materially consequential.`
...
**Signal:** **4.9/5 — major Build-OS, Product Loop, architecture-memory, Platform, and organizational-design source**

**Cross-source relationship:** This source reinforces the Wave-6 amplification law, risk-tiered verification, change-absorption limits, isolated parallel work, and outcome-based measurement. Its distinct yield is the separation of **machine-produced code from human-understood systems**, architecture decisions as an explicit pre-implementation control surface, a **cognitive concurrency limit** on human supervision, and the extension of “you build it, you run it” into **you secure adoption and verify value**.
...
> **AI can generate almost all of the implementation while humans must still understand, own, and continuously govern the system that implementation creates.**

The source rejects two misleading metrics:

- percentage of code written by AI;
- percentage of code reaching production without a human reading every line.

The harder question is:

> **Does an accountable human team understand the system’s boundaries, data movement, authority, failure modes, deployment model, and intended consequence?**

This is a deeper standard than code review and a more durable one than preserving human authorship.

---

### 1. OMNI needs an explicit system-understanding obligation

Batey’s central warning is that opacity can compound:

1. the agent workflow is opaque;
2. the generated implementation is opaque;
3. the generated tests and verification become opaque;
4. nobody understands the resulting system.

At that point, “tests passed” is no longer a sufficient assurance argument because the organization cannot explain:

- what was built;
- why it was built that way;
- what trust boundaries changed;
- what data can move where;
- what assumptions the tests encode;
- what remains unverified.

## Candidate: `system_understanding_record`

For consequential changes, the owning team should be able to state:

- intended outcome;
- system components affected;
- authoritative owners affected;
- trust boundaries crossed;
- identity and authorization path;
- data movement;
- public and private exposure;
- dependency and vendor impact;
- deployment and version-skew behavior;
- expected failure modes;
- blast radius;
- recovery and rollback;
- evidence that the implementation conforms.

This is not a requirement that a human remember every line of code.

It is a requirement that the accountable team retain a coherent model of the system they operate.

**Keeper line:**

> **Implementation may be machine-generated; system accountability cannot be machine-orphaned.**

---

### 2. Architecture decisions should precede implementation and remain continuously enforceable

The source’s strongest concrete practice is separating system-level decisions into a dedicated Architecture Decision Record before implementation begins.

The human team deeply reviews:
...
- compatibility and failure assumptions.

Agents then implement against the accepted record and can continuously check later changes for architectural drift.

This is more than documentation.

It forms a control chain:

`human-owned system decision → accepted architecture record → generated implementation → continuous conformance verification`

## Candidate: `architecture_conformance_gate`

A consequential implementation should declare:
...
- evidence of implementation alignment;
- whether later changes alter the accepted system shape.

The architecture record remains a candidate until accepted by the proper architecture and domain owners. Once accepted, an agent may help maintain conformance but cannot silently supersede it.

**Keeper line:**

> **Use agents to enforce architecture more consistently; do not use their ability to generate architecture prose as evidence that the architecture was understood or accepted.**

This directly strengthens OMNI’s architecture-memory control plane.

---

### 3. Verification opacity can become an infinite regress

The source depicts a dangerous progression:

- humans no longer inspect the implementation;
- humans rely on tests;
- agents generate the tests;
- agents generate the systems evaluating the tests;
- nobody understands the verification basis.

OMNI should preserve a **verification-root principle**:

> **Every consequential assurance chain must terminate in evidence whose meaning, ownership, and limitations are understood outside the generator being assessed.**

That root may include:

- deterministic checks;
- externally owned facts;
- independently gathered observations;
- explicit human/domain judgment;
- production telemetry;
- real-world outcome evidence.

It should not terminate only in:

- another agent;
- another generated test;
- another generated explanation;
- or consensus among models sharing the same assumptions.

**Hard counterweight:**

> **Verification depth is not the same as verification independence.**

A hundred machine-generated checks can still share one blind spot.

---

### 4. Human cognitive concurrency is a real runtime limit

The source describes engineers starting multiple parallel agent tasks during the idle time created by faster implementation.

The result:

- the first complex design is strong;
- the second is weaker;
- the third receives exhausted systems thinking;
- output volume rises while judgment quality declines.

This exposes a distinct constraint:

## Candidate: `cognitive_concurrency_budget`

A human operator’s capacity should be classified by work type:

- **complex reasoning work**
  - architecture, safety, domain modeling, cross-boundary decisions;

- **bounded review work**
  - evaluating a known pattern or constrained change;

- **lightweight supervisory work**
  - checking status, resolving narrow exceptions;

- **mechanical work**
  - low-risk administrative action.

Parallel agents create the illusion that every open task can be supervised simultaneously. In reality, complex human judgment does not parallelize like model execution.

A runtime or work-management surface should therefore expose:

- number of active missions;
- consequence class;
- unresolved decisions;
- expected review load;
- required systems-thinking depth;
- context-switch burden;
- whether the assigned human has already exceeded safe concurrency.

**Keeper line:**

> **Machine concurrency expands faster than human comprehension; orchestration must budget judgment, not merely agent slots.**

This is particularly important in care, where one clinician may be presented with many “decision-ready” candidates that each still require genuine thought.

---

### 5. Product work is not complete at deployment

The source expands the classic DevOps principle:

`you build it → you run it`

into:

`you build it → you run it → you drive adoption → you verify that it produced value`

The team found that machine-speed implementation produced too many features and too little adoption. Engineers could always begin the next interesting feature instead of determining whether the previous one helped anyone.

## Candidate: `product_change_outcome_record`

A product change should preserve:
...
- operational burden;
- realized effect;
- decision to expand, revise, retain, or retire.

Deployment is not closure.

Usage alone is also not closure.

The relevant question is whether the change produced the intended value without unacceptable consequence.

**Keeper line:**

> **A feature in production is still a candidate value proposition until real users adopt it and reality answers back.**

This strongly aligns with OMNI Reactor and the Product/Platform learning loops.

---

### 6. Flow must be measured from idea through adoption—not at the accelerated middle

The source observes uneven acceleration:

- implementation speeds up by an order of magnitude;
- product judgment speeds up less;
- architecture still requires deliberation;
- adoption may become slower because users are overwhelmed by change.

This creates a distorted flow:

`ideas → product judgment → implementation → verification → deployment → adoption → outcome`

Optimizing only implementation creates inventory and downstream congestion.

OMNI should measure:

- time from need to accepted decision;
- time from accepted decision to deployable change;
- time from deployment to adoption;
- time from adoption to verified effect;
- abandonment and rollback rate;
- change-absorption burden;
- unresolved outcome debt.

**Sharpening:** the bottleneck is dynamic and must be observed across the complete consequence chain.

**Keeper line:**

> **Accelerating one stage of a governed loop can make the total system slower, noisier, and less effective.**

---

### 7. Team topology must preserve local speed and global coherence

The source reduced product streams from conventional teams of six to eight into small mission cells of two to four.

Benefits:

- clearer mission;
- faster local coordination;
- direct ownership of defects, review, feedback, and adoption;
- less review backlog.

But smaller autonomous streams also risk divergence.

The source preserves coherence through:

- shared product ownership;
- explicit architecture review;
- people working across streams;
- system-level decisions separated from ordinary implementation.

This suggests a useful topology:

`small mission cell + cross-stream architecture stewardship + shared product intent`

The mission cell may own:
...
- enterprise safety floors;
- canonical truth.

**Keeper line:**

> **Local autonomy works only when shared architecture, product intent, and cross-boundary consequences remain actively stewarded.**

---

### 8. Loosely coupled architecture becomes more important under machine-speed change

The source argues that established engineering practices matter more, not less:
...
- survivable partial failure.

When implementation velocity increases, tightly coupled systems accumulate interactions faster than humans can reason about them.

The relevant goal is not maximal service decomposition. Poorly bounded services create a distributed monolith.
...
> **Architecture must limit the rate at which machine-generated local changes can create unbounded global consequence.**

---

### 9. Provider portability is operational resilience, not ideological purity

The source decomposes the machine producer into:

- interface or harness;
- hosted API;
- model.

It argues that teams should be able to switch providers when a model or API is unavailable.

The important lesson is not that all models must be open-source or self-hosted.

It is:

- avoid making one provider outage equivalent to organizational incapacity;
- retain access to system knowledge independent of the provider;
- preserve model-switching where the task allows;
- understand when output changes across providers;
- test critical workflows under alternate runtime configurations.

However, provider portability does not solve semantic dependence. If the organization only knows how to operate through one model’s behavior, vocabulary, or undocumented quirks, nominal switching is not resilience.

**Keeper line:**

> **A replaceable model is useful; a provider-independent operating understanding is essential.**

---

### 10. High AI-generated-code percentages are nearly meaningless

The source explicitly calls “90–100% AI-written code” a vanity metric.

That percentage says nothing about:

- whether the right thing was built;
- whether the system is understood;
- whether the architecture holds;
- whether users adopted it;
- whether incidents increased;
- whether maintenance became easier;
- whether humans retained enough judgment to recover it.

OMNI should similarly reject:

- percentage of agent-authored notes;
- percentage of automated messages;
- percentage of autonomous tasks;
- percentage of machine-generated recommendations

as standalone success measures.

The correct metric must include consequence and ownership.

---

## What not to import

- Every line of consequential code requiring literal human reading.
- Human review treated as sufficient without system understanding and evidence.
- Architecture records generated by agents and accepted without genuine human judgment.
- Acceptance tests treated as complete proof when their own assumptions and provenance are opaque.
- Unlimited parallel agent work assigned to one cognitively saturated human.
- Deployment or feature count treated as product value.
- Adoption pressure used to manipulate users into consuming unnecessary features.
- Engineers made solely responsible for adoption when product, training, pricing, workflow, or executive sponsorship are the real blockers.
- Tiny mission teams allowed to redefine shared contracts independently.
- Microservice decomposition treated as automatic loose coupling.
- Provider switching claimed without compatibility testing.
- Vendor lock-in treated as inherently unacceptable; it may be a deliberate bounded tradeoff.
- “Humans retain agency” asserted while all meaningful information is buried in generated artifacts they cannot evaluate.

## Hard verdict

This is one of the strongest product-engineering sources in the wave.

Its contribution is not another claim that AI accelerates development. It explains what must remain human-owned and systemically visible after implementation becomes cheap.

### Genuine architecture candidates

1. **`system_understanding_record`**
   - records the accountable team’s coherent model of boundaries, data, authority, failure, deployment, and recovery.

2. **`cognitive_concurrency_budget`**
   - limits parallel agent work according to the human judgment and context-switching burden required.

3. **`product_change_outcome_record`**
   - links product intent, deployment, adoption, observed value, burden, and final disposition.

### Major sharpenings

1. **Architecture conformance gate**
   - accepted system decisions precede implementation and remain continuously checked.

2. **Verification-root principle**
   - assurance chains must terminate in evidence understood outside the generator being evaluated.

3. **Idea-to-outcome flow**
   - measure the full path through adoption and effect, not implementation throughput.

4. **Mission-cell topology**
   - small teams gain speed while architecture and product intent retain cross-stream stewardship.

5. **Provider-independent operating understanding**
   - portability is useful only when the organization retains comprehension and recovery ability.

6. **Machine-speed blast-radius control**
   - loose coupling and short feedback cycles become more important as implementation accelerates.

### Principal counterweights

1. AI-generated-code percentage is a vanity metric.
2. Human code review is neither necessary nor sufficient for system accountability.
3. Parallel machine work must not exceed human systems-thinking capacity.
4. Deployment is not adoption, and adoption is not verified value.
5. Cheap implementation increases the importance of disciplined architecture, prioritization, and non-action.

### One-line read

**The responsible AI-native product team is not the one that removes humans from implementation fastest; it is the one that preserves human understanding of the system, constrains parallel work to real judgment capacity, and remains accountable until deployed change becomes adopted and verified value.**
...
**Reviewer:** Opus (repository-native) · **at:** `2026-07-19` · **depth:** `reduced / transcript-native` (see mis-paste note) · binds nothing (`GRD-036`/`GRD-044`). **PROPOSE-ONLY** — no mint, no promotion, no contract/thesis/registry edits.

### Method note (⚠️ read first)
The §3 Review 001 block in this file is **mis-pasted**: it is Knox's read of **Christopher Batey, "Building Product Teams in the Age of AI"** (self-labeled `EVSRC-2026-000296`), which does **NOT** correspond to this file's §1 transcript — a **"Design Review" podcast interview with Katie Dill (Stripe Head of Design) on the new Stripe homepage + AI in the design process**. Per pipeline doctrine ("transcript but NO matching Knox §3 Review 001 → process transcript-native at reduced depth and say so"), I formalized **from §1 verbatim only**, at reduced depth. **I did NOT import or formalize Batey's candidates/counterweights into this source** (that would misattribute a different source's interpretation). The Batey read should be re-homed to its correct EVSRC by the parent/operator. **Consequence for fidelity:** the counterweights below are **transcript-native (Opus-derived), not Knox-validated** → the 2nd reader should apply extra scrutiny, and this source is a strong candidate for **full-depth reread** once a correct Katie-Dill strategic read is captured. Dedup baseline = `EVRUN-2026-000011` registry; retired terms + `D0OL-GRD-001..008` not re-minted. Verdict: **0 net-new DOMAIN objects**; yield = Surface/Projection-plane sharpenings + a strong **craft/quality-floor** affirmation of OMNI care physics. Build reality: OMNI has artifact-pipeline / chart_ai_reviews / outbound-dispatch but no built-out Surface/Projection plane at this maturity → `doctrine AFFIRM/PARTIAL × build absent/partial`.

### Cluster table
| # | concept | OMNI meaning | homes | anchor (≤12w + ts) | doctrine × build | weight | status |
|---|---|---|---|---|---|---|---|
| 1 | Surface-as-manifesto | A surface indirectly expresses who the system is + what it truly cares about; an incoherent surface signals an incoherent substrate — Polaris composes not enforces, but composition still reveals doctrine | Surface plane (P5) · Polaris · projections (P4) | "what is the point of a website… it's your manifesto" ~5:30 | AFFIRM × absent | vocabulary | watch |
| 2 | Progressive disclosure / show-don't-tell / lean-back browse (bento + modals) | Reveal complex capability in layers without ejecting the user from context; reduce cognitive load; the older "keep adding sections and hope they scroll" is the anti-pattern | Surface/Projection plane · Care UX (clinician load) | "progressive disclosure as a way of… more details" ~10:23; "lean back… browse mode" ~26:49 | AFFIRM × partial | vocabulary | watch |
| 3 | Trust through quantified real-world outcome, not claims | The GDP-share / "billionth" counter earns trust via verifiable real-world outcome rather than assertion — directly REV-184 world-model-honesty; care projections must SHOW proof, not assert | REV-184 · Surface plane · Accountability Loop | "live counter of… the global GDP" ~7:12; "billionth… billions of transactions" ~8:24 | AFFIRM × partial | spine-adjacent | watch |
| 4 | AI raises the floor, NOT the ceiling; craft/taste/judgment irreplaceable | AI gets you to a fast "7/10" and lets you explore 20 ideas in the time of 2, but "it doesn't replace craft… taste… attention to detail"; each pixel still needs human attention → generated≠committed, AI-never-authority at the craft layer | §B · Care operating model · Build-OS · REV-184 | "it doesn't replace craft… taste" ~29:15; "each pixel… same amount of attention" ~28:56 | AFFIRM × absent | spine | watch |
| 5 | Gravitational pull to mediocrity / don't accept slop | Quality is active resistance: "the gravitational pull is to mediocrity… so easy to accept good enough"; every "good enough" compounds; you should NOT accept slop, you should fight for the right solution | Care quality-floor · Build-OS · Reactor | "fight the gravitational pull to mediocrity" ~36:51; "you should not accept slop" ~35:19 | AFFIRM × absent | spine-adjacent | watch (→ 08) |
| 6 | MVQP — minimum viable QUALITY product (consequence-tiered) | Progress > perfection AND perfection is a dangerous pursuit — but you must not erode trust by experimenting on real users below a quality floor; consequence framing = "erodes trust if you don't get this right… front page of the news" | Reactor (consequence floor) · Care/proof floor · Build Entry Gate | "minimum viable quality product" ~39:12; "erodes trust if you don't get this right" ~38:06 | AFFIRM × partial | vocabulary | watch |
| 7 | Cross-journey / composite coherence ("walking the store") | Per-stream local optimization silently breaks the whole ("updated the dining room… other rooms now look bad"); "essential journeys" scoreboard (red/yellow/green) + multi-POV walkthrough (engineer/PM/data-science) keep the composite coherent across business areas | Platform Loop · Accountability Loop · Care cross-domain journey · projections | "updated the dining room… other rooms now look bad" ~40:46; "essential journeys… red, yellow, green" ~41:51 | AFFIRM × partial | vocabulary | watch |
| 8 | Design systems + AI (governed component library, human keeps the bar) + democratized shipping | AI can help scale/expand the design system, but "this is what people have to CHOOSE to do" — the human owns the bar; everyone-can-ship raises the coherence-governance problem (govern coherence without being in the code-flow) | Build-OS · Platform Loop · Surface plane · Polaris | "everybody… ability to ship code and… update the website" ~32:26; "how do you keep… cohesive design language" ~32:44 | AFFIRM × absent | vocabulary | watch |
| 9 | Intention over decoration; "prototyping, not presenting" | "Not animations for animation's sake… intention and purpose behind everything"; judge as a user would experience it, don't defend in a stakeholder deck — realize outcomes in real context | Care UX · REV-184 (outcome-in-context) · Build-OS | "not animations for animation's sake" ~14:24; "prototyping, not presenting" ~37:24 | AFFIRM × partial | vocabulary | watch |
| 10 | Agent experience as a new design paradigm | "People are using agents to build their businesses… what is your agent experience?" — surfaces must be designed for agent-mediated interaction (the patient/operator agency seam, wave-6 296) | Surface plane · §B · Care (patient agency seam) · Polaris | "what is your agent experience?" ~31:57 | AFFIRM × absent | vocabulary | watch (Reactor/agency pressure) |

### Net-new dispositions (EVERY candidate → dedup / investigate / reject) — count: **0 candidates offered by the source → 0 mint · 0 investigate · all dedup-as-sharpening**
- The source proposes no architecture candidates (it is a design-craft interview, not an architecture talk). Concepts that *sound* nameable all `EXISTS-AS` prior canon:
  - **"minimum viable quality product (MVQP)"** → DEDUP: `EXISTS-AS` Reactor consequence floor + 283 consequence-sets-the-floor + Build Entry Gate. Section-sharpening (memorable vocabulary), not a DOMAIN.
  - **"essential journeys scoreboard" / "walking the store"** → DEDUP: `EXISTS-AS` cross-stream coherence + Platform/Accountability loops + version-skew/composite-coherence. Section-sharpening.
  - **"surface-as-manifesto"** → DEDUP: `EXISTS-AS` Surface plane (P5) + Polaris-composes-not-enforces. Section-sharpening.
- **Net-new DOMAIN objects: 0.** No retired term re-minted; `D0OL-GRD-001..008` not re-minted.

### Counterweights (EVERY caution preserved — NEVER inverted; ⚠️ transcript-native, NOT Knox-validated) — count: **6 preserved · 0 inverted**
1. AI raises the floor but shipping "sevens" / slop is the failure mode — do NOT treat AI ease/speed as license to lower the bar. ("don't just ship more sevens out of tens" ~31:26)
2. **Two-sided (do not invert either pole):** progress > perfection, YET perfection-chasing is itself dangerous, YET MVQP means you must not experiment on real users below a quality/trust floor. Preserve all three — not "ship fast, quality later" and not "polish forever." (~38:41 / ~39:12 / ~38:06)
3. Beauty/animation for its own sake is rejected — every element must carry intention/purpose. (~14:24)
4. Don't be "wooed by how easy that was" — ease of generation ≠ quality/greatness. (~34:46)
5. Design-in-isolation misleads — must be realized the way a user would experience it ("prototyping, not presenting"). (~37:24)
6. AI-managed/expanded design systems are an opportunity, but the human must actively **choose** to hold the bar — the tooling does not hold it for you. (~34:40)
- **No caution inverted.** (Because the matching Knox counterweight set is absent due to the mis-paste, the 2nd reader should treat this list as provisional and re-audit against a correct Knox read.)

### Care implications (0-net-new is a dedup fact, NOT permission to drop care cautions)
- **AI-never-care-authority at the craft/surface layer:** AI generates the artifact; human judgment/taste/commit remain required → affirms `generated≠committed` + `candidate≠commit`. A fast "7/10" AI-generated care surface does NOT meet the care/proof floor.
- **Quality floor = trust floor in care:** "erodes trust if you don't get this right" transfers directly — a merely "good enough" care projection erodes patient/clinician trust; the gravitational-pull-to-mediocrity is a live care risk, not just aesthetics.
- **Trust-through-outcome = REV-184:** care projections must earn trust through verifiable real-world outcome/proof (the GDP-counter mechanism), never through asserted social proof.
- **Cross-journey coherence = patient-journey coherence:** "walking the store" / "updated one room, others broke" maps to OMNI composite coherence across intake/scheduling/clinical/commerce/messaging — per-domain local optimization must not silently break the patient's whole experience (version-skew/composite-coherence).
- **Progressive disclosure = clinician cognitive-load management:** reveal complex capability in layers without ejecting the clinician from context.

### Guardrail candidates → route `08` open-review → `06` digest (PROPOSE-ONLY, `user_knox_required`; dedup noted)
- **G-309-1** AI raises the baseline floor, not the quality ceiling; a fast "good-enough / 7-of-10" generated surface is a **candidate**, not a shippable care/quality result. *(dedup vs `generated≠committed` 288 + `candidate≠commit`.)*
- **G-309-2** A surface/projection is a manifesto — it expresses (indirectly) what the system actually cares about; an incoherent surface signals incoherent substrate. *(→ Surface plane section-sharpening.)*
- **G-309-3** Trust is earned through quantified real-world outcome, never through asserted social proof. *(dedup vs REV-184 world-model-honesty + 288 outcome-evidence.)*
- **G-309-4** Composite cross-journey coherence must be actively walked; per-stream local optimization silently breaks the whole. *(dedup vs cross-stream coherence + version-skew.)*
- **G-309-5** Ease of AI generation must not bypass the human quality/taste bar for consequential surfaces ("fight the gravitational pull to mediocrity"). *(care-quality-floor guard.)*
- All → `08`; reviewer decides distinct-vs-sharpen-existing. Nothing promoted.

### Reread flags
- **⚠️ MAJOR — MIS-PASTE:** §3 Review 001 = Christopher Batey "Building Product Teams in the Age of AI" (`EVSRC-2026-000296`), NOT this Katie-Dill transcript. This source has **NO matching Knox read**; processed transcript-native at reduced depth. **Action for parent/operator:** re-home the Batey Knox read to its correct Batey EVSRC; do NOT let it be formalized as 309's interpretation. (I did not import it.)
- **Full-depth reread recommended** once a correct Katie-Dill strategic read is captured — upgrade this reduced-depth extraction then.
- **No screenshot dropped** → §0 identity fields `inferred`; `source_url` + `published_at` unknown.
- **Fidelity caveat:** counterweights are Opus-transcript-native, not Knox-validated → 2nd reader apply extra scrutiny.

### One-line hard read
**Even when machine generation makes surfaces cheap, OMNI's job at the surface/projection plane is to resist the gravitational pull to mediocrity: AI raises the floor but never the care/quality/trust ceiling, trust is earned through verifiable outcome not claims, and the composite patient journey must be actively "walked" for coherence — because a "good-enough" care surface erodes exactly the trust the substrate exists to protect.**
...
- EVRUN(s): `EVRUN-2026-000011` (ai-corpus wave-6) · concept_registry: `EVRUN-2026-000011_ai-corpus-wave-6_concept_registry_and_routing_map.md` (parent folds centrally; flag mis-paste + reduced-depth) · source_anchor_ledger: `EVRUN-2026-000011_ai-corpus-wave-6_source_anchor_ledger_receipts_only.md` · per-source deep-read: §3 Review 003 (this file) · impact: `Surface plane (P5) · projections (P4) · Polaris · Care quality/trust floor · Reactor · Platform/Accountability loops · REV-184` · promotion: `watch` (0 net-new DOMAIN; reduced-depth; 5 guardrail candidates → 08) · **flag: mis-paste (Batey Knox read); no matching Knox §3 Review 001; recommend full-depth reread**
