...
- status: `format APPROVED · batched routing IN PROGRESS (resumable checkpoints). Done: B1 (084/085/086, proof) + B2 (087/088, CNS/neural/sim) + B3 (089, Build-OS/loops) + B4 (079/080/081, §C/security/control-plane) = 542 concepts, 9/42 sources. Grouping by THEME going forward (per Nick). Uniform deep on all; batch-and-commit to avoid mid-pass data-loss.`
