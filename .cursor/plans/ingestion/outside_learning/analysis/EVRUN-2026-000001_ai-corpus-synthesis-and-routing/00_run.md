...
- status: `format APPROVED · batched routing IN PROGRESS (resumable checkpoints). Done: Batch 1 (084/085/086, proof) + Batch 2 (087/088, CNS/neural/simulation) + Batch 3 (089, Build-OS/loops) = 396 concepts, 6/42 sources. Next: Batch 4 = 079/080/081 (§C/security/control-plane). Uniform deep on all; batch-and-commit to avoid mid-pass data-loss.`
