...
15. **Current Checkpoint Handoff:** `.cursor/plans/HANDOFF_2026-06-14_c3_5_complete_c3_6_oncology_addendum_pre_c4.md` (current, 2026-06-14 — C3.5 Hospital/EHR-Gravity arc COMPLETE [G4 + G4.1] + C3.6 Oncology/Trials Clinical-Substrate addendum COMPLETE [A–G], both handoff-safe; gates C2 CLOSED · C3 PASSED · C3.1 PASSED · C4.0 ACCEPTED · C3.5 COMPLETE · C3.6 COMPLETE; NEXT = C4 readiness / v4 continuity; **controlling plan in HOME dir `~/.cursor/plans/wave-2_source_scaffolding_654989a0.plan.md`**; do NOT author v4 prose yet; do NOT run more scenario batches). Tier-3 narrative: `docs/architecture/evolution_narrative_volume_6_2026-06-14.md`. Lineage: `…06-06` → `…06-10` → `…06-13_v4_prep_through_c3_5_arc_setup` → this 06-14 arc-close handoff. **Prior handoffs are historical-only** (06-13 v4-prep gates + C3.5-setup detail, 06-10 wave-2 ingestion, 06-06 Evidence-Plane/`GRD-036..042` detail all stay valid as detail). Operational state transfer; updated each Tier 2+ checkpoint per `agent_work_protocol.md` §8 **Checkpoint Closeout Rule**. **Drift-guard: this entry MUST name the same file as `AGENTS.md` `## OMNI Operating References` Current Checkpoint Handoff; if they differ, the §1 Boot Freshness Check fires → STOP.**
