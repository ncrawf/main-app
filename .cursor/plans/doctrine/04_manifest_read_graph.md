...
15. **Current Checkpoint Handoff:** `.cursor/plans/HANDOFF_2026-06-03_ai_substrate_frame_ratified.md` (current; lineage `HANDOFF_2026-05-30_foundation_vnext_pivot.md` → `HANDOFF_2026-06-03_surface_plane_and_pre_ai_immersion.md` → this AI-substrate-frame handoff; operational state transfer; updated each Tier 2+ checkpoint per `agent_work_protocol.md` §8 Checkpoint Preservation Rule; prior handoffs become historical-only). Prior current-checkpoint `HANDOFF_2026-05-23_post_tier0_activation_pre_omni_thesis_refinement.md` is now historical/arc reference (its Extension #33 remains useful context; see new handoff §5 for how the Foundation vNext pivot reframes that queue).
