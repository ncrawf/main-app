/**
 * Write handler stub for target='patient_address'.
 *
 * Canonical destination: patient_addresses row.
 *
 ...
 */
export async function writePatientAddress(_args: WritePatientAddressArgs): Promise<WritePatientAddressResult> {
  throw new Error("lib/intake/write/patient_address.ts not implemented; Phase 4 runtime fills this in per Section 1Q.7 same-transaction discipline.");
}
