/**
 * Write handler stub for target='consent'.
 *
 * Canonical destination: patient_consents row per Section 1K.11.
 *
 ...
 */
export async function writeConsent(_args: WriteConsentArgs): Promise<WriteConsentResult> {
  throw new Error("lib/intake/write/consent.ts not implemented; Phase 4 runtime fills this in per Section 1Q.7 same-transaction discipline.");
}
