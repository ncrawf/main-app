/**
 * Write handler stub for target='advance_directive'.
 *
 * Canonical destination: patient_advance_directives administrative entity row.
 *
 ...
 */
export async function writeAdvanceDirective(_args: WriteAdvanceDirectiveArgs): Promise<WriteAdvanceDirectiveResult> {
  throw new Error("lib/intake/write/advance_directive.ts not implemented; Phase 4 runtime fills this in per Section 1Q.7 same-transaction discipline.");
}
