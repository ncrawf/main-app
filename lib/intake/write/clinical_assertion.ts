/**
 * Write handler stub for target='clinical_assertion'.
 *
 * Canonical destination: patient_clinical_assertions row per Section 1K.5.A canonical schema.
 *
 ...
 */
export async function writeClinicalAssertion(_args: WriteClinicalAssertionArgs): Promise<WriteClinicalAssertionResult> {
  throw new Error("lib/intake/write/clinical_assertion.ts not implemented; Phase 4 runtime fills this in per Section 1Q.7 same-transaction discipline.");
}
