...
export const reproductiveQuestions: Question[] = [
  {
    question_id: 'qb.domain.reproductive.baseline_v1',
    ...
    render_when: null,
    prompt: 'reproductive baseline history',
    helper: 'Module reproductive per domain_modules_v1.md; full question content per spec.',
