...
export const cardiometabolicQuestions: Question[] = [
  {
    question_id: 'qb.domain.cardiometabolic.baseline_v1',
    ...
    render_when: null,
    prompt: 'cardiometabolic baseline history',
    helper: 'Module cardiometabolic per domain_modules_v1.md; full question content per spec.',
