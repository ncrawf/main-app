...
export const mental_healthQuestions: Question[] = [
  {
    question_id: 'qb.domain.mental_health.baseline_v1',
    ...
    render_when: null,
    prompt: 'mental_health baseline history',
    helper: 'Module mental_health per domain_modules_v1.md; full question content per spec.',
