...
export const gastrointestinalQuestions: Question[] = [
  {
    question_id: 'qb.domain.gastrointestinal.baseline_v1',
    ...
    render_when: null,
    prompt: 'gastrointestinal baseline history',
    helper: 'Module gastrointestinal per domain_modules_v1.md; full question content per spec.',
