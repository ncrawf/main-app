...
- Current Checkpoint Handoff — `.cursor/plans/HANDOFF_2026-06-13_v4_prep_through_c3_5_arc_setup.md` (2026-06-13; **v4 authoring runway in progress** — wave-2 ingestion COMPLETE [EVRUN-2026-000002 110/110]; gates **C2 CLOSED · C3 PASSED · C3.1 PASSED · C4.0 ACCEPTED**; **C3.5 Hospital-Grade EHR-Gravity Pressure-Test Arc stood up** [run next in a SEPARATE agent via `v4_C3_5_KICKOFF_PROMPT.md`, starting at its Gate 1]; **do NOT author v4 prose yet**. **★ The controlling plan lives in the HOME dir `~/.cursor/plans/wave-2_source_scaffolding_654989a0.plan.md` — not the workspace tree.** Supersedes the 2026-06-10 ingestion handoff [historical] and the 2026-06-06 Evidence-Plane handoff [historical; `GRD-036..042` detail stays valid]) + see Read Graph Tier 0 Universal Path #15
