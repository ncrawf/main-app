...
- Current Checkpoint Handoff — `.cursor/plans/HANDOFF_2026-06-14_c3_5_complete_c3_6_oncology_addendum_pre_c4.md` (2026-06-14; **C3.5 Hospital/EHR-Gravity arc COMPLETE [G4 + G4.1] + C3.6 Oncology/Trials Clinical-Substrate addendum COMPLETE [A–G]; both handoff-safe**; gates **C2 CLOSED · C3 PASSED · C3.1 PASSED · C4.0 ACCEPTED · C3.5 COMPLETE · C3.6 COMPLETE**; **NEXT = C4 readiness / v4 continuity** [continuity agent writes the C4 authoring plans folding in both arcs, then a fresh v4 agent passes the C4 Author Readiness Note]; **do NOT author v4 prose yet; do NOT run more scenario batches**. **★ The controlling plan lives in the HOME dir `~/.cursor/plans/wave-2_source_scaffolding_654989a0.plan.md` — not the workspace tree.** Tier-3 narrative: `docs/architecture/evolution_narrative_volume_6_2026-06-14.md`. Supersedes the 2026-06-13 v4-prep handoff [historical; v4-prep gates + C3.5 setup detail stays valid], 2026-06-10 ingestion [historical], 2026-06-06 Evidence-Plane [historical; `GRD-036..042` detail valid]) + see Read Graph Tier 0 Universal Path #15
